...
/**
 * Created by Meng Ruo on 2018/7/20  11:01.
 **/
public class JdbcTemplateTokenStore implements TokenStore {
    private static final Log LOG = LogFactory.getLog(JdbcTemplateTokenStore.class);
    ...
    public JdbcTemplateTokenStore(DataSource dataSource) {
    ...
    public OAuth2AccessToken readAccessToken(String tokenValue) {
        ...
        try {
            accessToken = jdbcTemplate.queryForObject(selectAccessTokenSql, (rs, rowNum) -> deserializeAccessToken(rs.getBytes(2)), extractTokenKey(tokenValue));
        }
        catch (EmptyResultDataAccessException e) {
    ...
    public Collection<OAuth2AccessToken> findTokensByClientId(String clientId) {
        ...
        try {
            accessTokens = jdbcTemplate.query(selectAccessTokensFromClientIdSql, new JdbcTemplateTokenStore.SafeAccessTokenRowMapper(),
                    clientId);
        }
        catch (EmptyResultDataAccessException e) {
            if (LOG.isInfoEnabled()) {
    ...
    public Collection<OAuth2AccessToken> findTokensByUserName(String userName) {
        ...
        try {
            accessTokens = jdbcTemplate.query(selectAccessTokensFromUserNameSql, new JdbcTemplateTokenStore.SafeAccessTokenRowMapper(),
                    userName);
        }
        catch (EmptyResultDataAccessException e) {
            if (LOG.isInfoEnabled())
    ...
    public Collection<OAuth2AccessToken> findTokensByClientIdAndUserName(String clientId, String userName) {
        ...
        try {
            accessTokens = jdbcTemplate.query(selectAccessTokensFromUserNameAndClientIdSql, new JdbcTemplateTokenStore.SafeAccessTokenRowMapper(),
                    userName, clientId);
        }
        catch (EmptyResultDataAccessException e) {
            if (LOG.isInfoEnabled()) {
